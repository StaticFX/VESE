...
public class NeedsItemDAO extends DAO {
     ...
     * All needs satisfied by the Item.
     */
    public static final DataBaseStructure NEEDSITEMDAO = new DataBaseStructure((Arrays.asList(
            new Column("SimulationID","VARCHAR(36)", false),
            new Column("ItemID","VARCHAR(36)", false))));


    public NeedsItemDAO(DataBaseStructure structure) {
        super(structure);
    }
