...
public class PersonalityDAO extends DAO {

    /**
     * SimulationID is the ID of the Simulation
     * ParticipantID is the ID of the participant (used to access Personality, needs, etc.)
     * All priorizationValues, ImportanceOfNeeds and valueOfTraits
     */
    public static final DataBaseStructure PERSONALITYDAO = new DataBaseStructure((Arrays.asList(
            new Column("SimulationID","VARCHAR(36)", false),
            new Column("ParticipantID","VARCHAR(256)",true))));


    public PersonalityDAO(DataBaseStructure structure) {
        super(structure);
    }
